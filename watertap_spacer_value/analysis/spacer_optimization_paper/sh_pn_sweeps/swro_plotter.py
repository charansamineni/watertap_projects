...
def make_binned_heatmaps(
    ...
    for group_idx, metrics in enumerate(metric_groups):
        ...
        plt.savefig(
            f"../sh_pn_sweeps/swro/heatmap{group_idx + 1}.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.show()
...
if __name__ == "__main__":
    ...
    correlation_df = pd.read_excel("../correlation_comparison/SWRO_results.xlsx")
    ...
    make_binned_heatmaps(
        ...
        zlims={
            ...
            "Energy Consumption": (4.1, 6.7, 10),
            "LCOW": (0.73, 1.13, 10),
            "Average telescoping potential": (0, 1.5, 10),
